...
const Footer = () => {
  return (
    <>
        <footer className="bg-dark pt-24 pb-12 w-full">
        <div className="container">
            <div className="flex flex-wrap">
            <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                <h2 className="font-bold text-4xl text-white mb-5">Muwatok Dev</h2>
                <h3 className="font-bold text-2xl mb-2">Hubungi Kami</h3>
                <p>muwatok123@gmail.com</p>
                <p>Tlompakan, RT 02 / RW 03, Tuntang</p>
                <p>Semarang</p>
            </div>
            ...
            <div className="flex items-center justify-center mb-5">
                {/* <!-- Youtube --> */}
                <a
                href="https://www.youtube.com/channel/UCrF3Q5fKyW25ZT5_szqnUcw"
                target="_blank"
                ...
                {/* <!-- Instagram --> */}
                <a
                href="https://instagram.com/imammuwatok/"
                target="_blank"
                className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* <!-- github --> */}
                <a
                href="https://github.com/imam-muwatok"
                target="_blank"
                className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                ...
                {/* <!-- LinkedIn --> */}
                <a
                href="https://www.linkedin.com/in/muhammad-imam-muwatok-276669141/"
                target="_blank"
                className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="font-medium text-xs text-white text-center">
                Dibuat dengan <span className="text-pink-500">❤️</span> oleh <a href="https://www.instagram.com/imammuwatok/" target="_blank" >
                <span className="font-bold text-sky-300 hover:text-white">Muhammad Imam Muwatok</span>
                </a>, menggunakan
                <a href="https://tailwindcss.com" target="_blank" className="font-bold ms-1 hover:text-white text-sky-500">Tailwind CSS</a>.
            </p>
            </div>
        </div>
        </footer>
